...
| Three bundled dependencies on a PWA | the app is installable and must stay light | measured before and after; the budget is the current 630KB precache, and a material rise is a finding |
